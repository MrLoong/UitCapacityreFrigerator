...
namespace UitCapacityreFrigerator.Communication
{
    public class IController
    {
        ...
        public IController()
        {
            ...
            comModel.comReceiveDataEvent += new SerialPortEventHandler(this.ComReceiveDataEvent);
        }
        public void ComReceiveDataEvent(Object sender, SerialPortEventArgs e)
        {

            //MessageBox.Show(IController.Bytes2Hex(e.receivedBytes).Replace("-",""));

            OnCompleted(Encoding.Default.GetString(e.receivedBytes));
           // MessageBox.Show(Encoding.Default.GetString(e.receivedBytes));
            //OnCompleted(IController.Bytes2Hex(e.receivedBytes));
        }
        // 向宿主页面显示消息
